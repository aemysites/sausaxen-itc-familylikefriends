...
## Environments
- Preview: https://main--sausaxen-itc-familylikefriends--aemysites.aem.page/
- Live: https://main--sausaxen-itc-familylikefriends--aemysites.aem.live/
...
1. Open the `sausaxen-itc-familylikefriends` directory in your favorite IDE and start coding :)
